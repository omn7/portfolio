        ...
        <main className="max-w-4xl mx-auto px-6 py-6 flex flex-col min-h-screen font-mono">
            ...
            <div className="mb-16">
                ...
                <div className="space-y-6 text-[1.05rem] leading-relaxed text-[var(--text-alt)] max-w-2xl">
                    ...
                    <p>
                        Previously, I worked as an Intern at <Link to="/experience" className="text-[var(--text)] underline underline-offset-4 hover:opacity-80 transition-opacity">SR Analytics</Link>, where I gained real-world exposure to development workflows and problem-solving in a professional environment.
                    </p>
