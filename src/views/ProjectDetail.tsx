...
export default function ProjectDetail({ params: propParams }: { params?: { id: string } }) {
  ...
  if (!project) {
    return (
      <main className="max-w-4xl mx-auto px-6 py-6 flex flex-col items-center justify-center min-h-screen font-mono">
        ...
        <Link href="/projects" className="text-[var(--text-alt)] hover:text-[var(--text)] hover:underline">
          ← back to projects
        </Link>
      </main>
    );
    ...
    <main className="max-w-4xl mx-auto px-6 py-6 flex flex-col min-h-screen font-mono">
      ...
      <div className="mb-4 mt-2 sm:mt-6">
        <div className="flex items-center justify-between mb-8">
          <Link href="/projects" className="text-[var(--text-alt)] hover:text-[var(--text)] hover:underline inline-block">
            ← back to projects
          </Link>
          <button
            onClick={() => setDark((d) => !d)}
